...
#'Fall17V1_SMuBlockF',
 ...
 datasetinputs = [
 # Dineutrino dataset
 '/MET/Run2016B-07Aug17_ver2-v1/MINIAOD',
 '/MET/Run2016C-07Aug17-v1/MINIAOD',
 '/MET/Run2016D-07Aug17-v1/MINIAOD',
 '/MET/Run2016E-07Aug17-v1/MINIAOD',
 '/MET/Run2016F-07Aug17-v1/MINIAOD',
 '/MET/Run2016G-07Aug17-v1/MINIAOD',
 '/MET/Run2016H-07Aug17-v1/MINIAOD',
...
goodRunsLists = [
'/afs/cern.ch/work/t/tayu/private/Tprime_dineutrino_2016/CMSSW_9_4_9_cand2/src/BSMFramework/BSM3G_TNT_Maker/data/JSON/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt',
]
...
for d in range(0,1):
    ...
    if 'METF' in datasetnames[d]:
        ...
        JECFiles = JECBlockF
        tempJSON = goodRunsLists[0]
    if 'METG' in datasetnames[d]:
        print 'multicrab.py: Run MET G'
        JECFiles = JECBlockG
        tempJSON = goodRunsLists[0]
    if 'METH' in datasetnames[d]:
        print 'multicrab.py: Run MET H'
        JECFiles = JECBlockH
        tempJSON = goodRunsLists[0]    
    ...
    config.JobType.psetName    = '/afs/cern.ch/work/t/tayu/private/Tprime_dineutrino_2016/CMSSW_9_4_9_cand2/src/BSMFramework/BSM3G_TNT_Maker/python/miniAOD_RD2016.py'
