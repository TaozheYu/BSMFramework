...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
    '/store/mc/RunIIAutumn18MiniAOD/TprimeBToTZ_M-900_LH_TuneCP5_PSweights_13TeV-madgraph_pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v1/80000/15E0CE5B-0BB4-134E-89FF-4A17A34D064C.root'
  ),
...
process.noHFCands = cms.EDFilter("CandPtrSelector",
                                 ...
                                 cut=cms.string("abs(pdgId)!=1 && abs(pdgId)!=2 && !(eta>-3.0 && eta<-1.4 && phi>-1.57 && phi<-0.87)")
                                 )
