...
void TriggerSelector::Fill(const edm::Event& iEvent, const edm::EventSetup& iSetup){
  ...
  if(_reHLT || _is_data){
    ...
    HLT_PFHT700_PFMET85_PFMHT85_IDTight = 1;
    HLT_PFHT800_PFMET75_PFMHT75_IDTight = 1;
    HLT_CaloJet500_NoJetID = 1;
    HLT_PFHT1050 = 1;
    HLT_MonoCentralPFJet80_PFMETNoMu120_PFMHTNoMu120_IDTight = 1;
    HLT_PFMET120_PFMHT120_IDTight = 1;
